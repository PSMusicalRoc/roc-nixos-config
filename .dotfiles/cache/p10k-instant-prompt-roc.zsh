...
() {
  ...
  typeset -g __p9k_instant_prompt_param_sig=$'\'\'\C-A5.9\C-Azsh-5.9-0-g73d3173\C-A\C-Avscode\C-A1\C-Aroc%\C-A\C-A\C-A/nix/store/hba33rs06nia9k4sd4xqzdvwlg12wqmv-gitstatus-1.5.4/bin/gitstatusd\C-A\C-A\C-A\C-A1\C-A0\C-A0\C-A\C-A%B%S%#%s%b\C-A1\C-AUTF-8\C-A\C-A\C-A0\C-A1\C-A/nix/store/pss82lfvvzy5zavvvc7kg4ii5mkp9bjc-powerlevel10k-1.20.0/share/zsh-powerlevel10k\C-A\C-A\C-A\C-A\C-A1\C-A256\C-A0\C-A/home/roc/.p10k.zsh'
  local gitstatus_dir=/nix/store/pss82lfvvzy5zavvvc7kg4ii5mkp9bjc-powerlevel10k-1.20.0/share/zsh-powerlevel10k/gitstatus
  ...
  local cr=$'\r' lf=$'\n' esc=$'\e[' rs=$'\x1e' us=$'\x1f'
  local -i height=1
  local prompt_dir=/home/roc/.cache/p10k-roc
